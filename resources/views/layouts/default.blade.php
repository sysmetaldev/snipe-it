...
<head>
    ...
    <style nonce="{{ csrf_token() }}">
        ...
        .skin- {
                {
                $snipeSettings->skin !=''? $snipeSettings->skin: 'blue'
            }
        }
        ...
        <div class="wrapper">
                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li aria-hidden="true" {!! (Request::is('purchases*') ? ' class="active"' : '' ) !!}
                                tabindex="-1">
                                <a href="{{ route('purchases.index') }}" accesskey="2" tabindex="-1">
                                ...
                                <form class="navbar-form navbar-left form-horizontal" role="search"
                                    ...
                                    <div class="col-xs-12 col-md-12">
                                        <div class="col-xs-12 form-group">
                                            <label class="sr-only" for="tagSearch">{{ trans('general.lookup_by_tag')
                                                }}</label>
                            ...
                            <li class="dropdown tasks-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="header">{{ trans('general.quantity_minimum', array('count' =>
                                        count($alert_items))) }}</li>
                                    <li>
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li {!! (\Request::route()->getName()=='home' ? ' class="active"' : '') !!} class="firstnav">
                            <a href="{{ route('home') }}">
                                <i class="fas fa-tachometer-alt fa-fw" aria-hidden="true"></i> <span>{{
                        ...
                        <li class="treeview{{ (Request::is('hardware*') ? ' active' : '') }}">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="{{ route('statuslabels.show', ['statuslabel' => $status_nav->id]) }}">
                                        <i class="fas fa-circle text-grey fa-fw" aria-hidden="true" {!!
                                            ($status_nav->color!='' ? ' style="color: '.e($status_nav->color).'"' : '')
                                            !!}></i>
                                ...
                                <li{!! (Request::query('status')=='Undeployable' ? ' class="active"' : '' ) !!}><a
                                    ...
                                    <li{!! (Request::query('status')=='Archived' ? ' class="active"' : '' ) !!}><a
                                        ...
                                        <li{!! (Request::query('status')=='Requestable' ? ' class="active"' : '' ) !!}>
                                            <a href="{{ url('hardware?status=Requestable') }}"><i
                                                ...
                                                <li{!! (Request::is('hardware/audit/overdue') ? ' class="active"' : '' )
                                                    ...
                                                    <li{!! (Request::is('hardware/quickscancheckin') ? ' class="active"'
                                                        ...
                                                        <li{!! (Request::is('hardware/bulkcheckout') ? ' class="active"'
                                                            ...
                                                            <li{!! (Request::is('hardware/requested')
                                                                ? ' class="active"' : '' ) !!}>
                                            ...
                                            <li{!! (Request::is('users*') ? ' class="active"' : '' ) !!}>
                                                ...
                                                <li{!! (Request::is('import/*') ? ' class="active"' : '' ) !!}>
                                                    ...
                                                    <li
                                                        ...
                                                        <ul class="treeview-menu">
                                                            @if(Gate::allows('view', App\Models\CustomField::class) ||
                                                            Gate::allows('view', App\Models\CustomFieldset::class))
                                                    ...
                                                    @can('reports.view')
                                                    <li
                                                        class="treeview{{ (Request::is('reports*') ? ' active' : '') }}">
                                                        ...
                                                        <ul class="treeview-menu">
                                                            ...
                                                            <li>
                                                                <a href="{{ url('reports/depreciation') }}" {{
                                                                    (Request::is('reports/depreciation')
                                                                    ? ' class="active"' : '' ) }}>
                                                            ...
                                                            <li>
                                                                <a href="{{ url('reports/asset_maintenances') }}" {{
                                                                    (Request::is('reports/asset_maintenances')
                                                                    ? ' class="active"' : '' ) }}>
                                                            ...
                                                            <li>
                                                                <a href="{{ url('reports/unaccepted_assets') }}" {{
                                                                    (Request::is('reports/unaccepted_assets')
                                                                    ? ' class="active"' : '' ) }}>
                                                            ...
                                                            <li>
                                                                <a href="{{ url('reports/accessories') }}" {{
                                                                    (Request::is('reports/accessories')
                                                                    ? ' class="active"' : '' ) }}>
                                                    ...
                                                    @can('viewRequestable', \App\Models\Asset::class)
                                                    <li{!! (Request::is('account/requestable-assets')
                                                        ? ' class="active"' : '' ) !!}>
                                                        <a href="{{ route('requestable-assets') }}">
                                                            <i class="fa fa-laptop fa-fw"></i>
                                                            <span>{{ trans('admin/hardware/general.requestable')
                                                                }}</span>
                                                        </a>
                                                        </li>
                                                        @endcan
            ...
            <div class="content-wrapper" role="main" id="setting-list">
                ...
                <div class="row" style="margin-bottom: 0px; background-color: red; color: white; font-size: 15px;">
                    <div class="col-md-12"
                        ...
                        <i class="fas fa-exclamation-triangle fa-3x pull-left"></i> <strong>{{
                            strtoupper(trans('general.debug_warning')) }}:</strong>
            ...
            <footer class="main-footer hidden-print">
                ...
                <div class="pull-right hidden-xs">
                    ...
                    @if (($snipeSettings->version_footer=='on') || (($snipeSettings->version_footer=='admin') &&
                    (Auth::user()->isSuperUser()=='1')))
                    &nbsp; <strong>Version</strong> {{ config('version.app_version') }} - build {{
                    config('version.build_version') }} ({{ config('version.branch') }})
                    @endif
                    @endif

                    @if ($snipeSettings->support_footer!='off')
                    @if (($snipeSettings->support_footer=='on') || (($snipeSettings->support_footer=='admin') &&
                    (Auth::user()->isSuperUser()=='1')))
                    ...
                    <a target="_blank" class="btn btn-default btn-xs" rel="noopener"
                        href="{{  $snipeSettings->privacy_policy_link }}" target="_new">{{
                        trans('admin/settings/general.privacy_policy') }}</a>
                    @endif
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <form method="post" id="deleteForm" role="form">
                            ...
                            <button type="submit" class="btn btn-outline" id="dataConfirmOK">{{ trans('general.yes')
                                }}</button>
                        </form>
                    </div>
                </div>
